...
export default function ExportModal({ isOpen, onClose, utterances, caseMeta, stats }: ExportModalProps) {
  if (!isOpen) return null;

  const hash = 'a3f9c2e8b7d14f6a9c3e2b8d7f1a4e6c9b2d8f7a3e1c4b6d9f2a8e7c3b1d5f4';
  ...
  return (
    <div className="fixed inset-0 z-[100] flex" style={{ background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(8px)' }}>
      ...
      <div className="w-[400px] overflow-y-auto p-8" style={{ background: 'hsl(var(--bg-panel))', borderLeft: '1px solid hsl(var(--border-subtle))' }}>
        ...
        <button className="btn-gold w-full mb-3">⬇ Download .docx (CrPC format)</button>
